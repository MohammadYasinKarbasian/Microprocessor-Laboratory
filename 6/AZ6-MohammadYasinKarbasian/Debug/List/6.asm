...
_0x20000:
	...
	.DB  0x20,0x32,0x0,0x41,0x44,0x43,0x5B,0x25
	.DB  0x64,0x5D,0x20,0x3D,0x20,0x25,0x64,0x6D
	.DB  0x76,0x0
_0x40000:
	.DB  0x51,0x75,0x65,0x73,0x74,0x69,0x6F,0x6E
	.DB  0x20,0x31,0x0,0x41,0x44,0x43,0x5B,0x25
	.DB  0x64,0x5D,0x20,0x3D,0x20,0x25,0x64,0x6D
	.DB  0x76,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0001 001F             previous[index] = data;
	MOVW R30,R18
	LDI  R26,LOW(_previous)
	LDI  R27,HIGH(_previous)
	LSL  R30
	ROL  R31
	ADD  R26,R30
	ADC  R27,R31
...
; 0001 0033     data = read_adc(0);
	...
	LDI  R26,LOW(0)
	LDI  R27,HIGH(0)
	LDI  R30,LOW(_0x2000F*2)
	LDI  R31,HIGH(_0x2000F*2)
	CALL __INITLOCB
;	data -> Y+8
;	duty_cycle -> Y+4
;	cache -> Y+0
