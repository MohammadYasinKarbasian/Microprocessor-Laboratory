...
_0x4:
	.DB  0x1
_0x20000:
	.DB  0x25,0x64,0x0,0x20,0x20,0x20,0x20,0x20
	.DB  0x20,0x20,0x20,0x0,0x52,0x50,0x4D,0x0
	.DB  0x44,0x43,0x3A,0x20,0x25,0x64,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0018 display_rpm=0;
	STS  _display_rpm,R30
	STS  _display_rpm+1,R30
; 0000 0019 counter=0;
	STS  _counter,R30
	STS  _counter+1,R30
; 0000 001A speed=0;
...
; 0001 0074   if(rpm-display_rpm >=5 || rpm-display_rpm <=-5){
	LDS  R26,_display_rpm
	LDS  R27,_display_rpm+1
	LDS  R30,_rpm
	LDS  R31,_rpm+1
	SUB  R30,R26
	SBC  R31,R27
...
; 0001 0077     sprintf(str, "DC: %d", display_rpm);
	...
	ST   -Y,R31
	ST   -Y,R30
	LDS  R30,_display_rpm
	LDS  R31,_display_rpm+1
	CALL SUBOPT_0xA
